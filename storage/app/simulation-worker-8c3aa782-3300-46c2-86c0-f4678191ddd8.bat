...
"C:\xampp\php\php.exe" "C:\Proyectos\cursor\omnichannel-ddd-eda\artisan" platform:simulation:execute-run 8c3aa782-3300-46c2-86c0-f4678191ddd8 --env=client-pruebas --no-ansi >> "C:\Proyectos\cursor\omnichannel-ddd-eda\storage\logs\simulation-worker-8c3aa782-3300-46c2-86c0-f4678191ddd8.log" 2>&1
