...
"C:\xampp\php\php.exe" "C:\Proyectos\cursor\omnichannel-ddd-eda\artisan" platform:simulation:execute-run e13f4437-3e3c-4b71-9e4e-2147dbad41d4 --env=client-pruebas --no-ansi >> "C:\Proyectos\cursor\omnichannel-ddd-eda\storage\logs\simulation-worker-e13f4437-3e3c-4b71-9e4e-2147dbad41d4.log" 2>&1
