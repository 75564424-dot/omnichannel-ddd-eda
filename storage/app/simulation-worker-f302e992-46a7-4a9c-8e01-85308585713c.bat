@echo off
set APP_KEY="base64:1e6/Mwx4m00yZ3jErjkJ+1HdWmk54ym2IAL3Xf+kJXg="
...
"C:\xampp\php\php.exe" "C:\Proyectos\cursor\omnichannel-ddd-eda\artisan" platform:simulation:execute-run f302e992-46a7-4a9c-8e01-85308585713c --env=client-pruebas --no-ansi >> "C:\Proyectos\cursor\omnichannel-ddd-eda\storage\logs\simulation-worker-f302e992-46a7-4a9c-8e01-85308585713c.log" 2>&1
