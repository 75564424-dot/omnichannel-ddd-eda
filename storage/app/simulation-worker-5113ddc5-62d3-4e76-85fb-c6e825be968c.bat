@echo off
set APP_KEY="base64:MmWqDlqK56How5wcePi4hkPC+8oi52ahb39ySBnOktI="
...
"C:\xampp\php\php.exe" "C:\Proyectos\antigravity\omnichannel-ddd-eda\artisan" platform:simulation:execute-run 5113ddc5-62d3-4e76-85fb-c6e825be968c --env=client-pruebas --no-ansi >> "C:\Proyectos\antigravity\omnichannel-ddd-eda\storage\logs\simulation-worker-5113ddc5-62d3-4e76-85fb-c6e825be968c.log" 2>&1
