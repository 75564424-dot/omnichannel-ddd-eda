...
Documentar y rastrear la suite **E2E** del proyecto: cada ficha siguiente describe un método de prueba y su lectura arquitectónica respecto al **middleware** (transporte/enrutado sin negocio de dominio).

## 2. Alcance
Capa **E2E**: simulación multi-paso tipo instancia cliente: configuración, publicación y observabilidad. No sustituye la lectura del código fuente de los asserts.
...
Regenerar tras cambios: `php docs/testing/tools/generate_test_catalogs.php`. Ejecutar `php vendor/bin/phpunit --testsuite E2E`.
...
Este archivo lista las pruebas de la capa **E2E** con la plantilla estándar del proyecto.
...
## Objetivo
Validar el comportamiento descrito por el método `multi_event_type_client_sync_publish_queue_catalog_and_event_status_remain_consistent` en `C:/Proyectos/cursor/omnichannel-ddd-eda/tests/E2E/Middleware/ClientProductionLikeSimulationTest.php`, alineado al bounded context **Middleware** y a la capa **Unknown**.
...
## Descripción
Ejecución PHPUnit sobre la clase `ClientProductionLikeSimulationTest`. Las aserciones concretas están en el código fuente del test; esta ficha documenta el propósito y la lectura arquitectónica.
...
## Objetivo
Validar el comportamiento descrito por el método `all_versioned_client_fixtures_simulate_successfully` en `C:/Proyectos/cursor/omnichannel-ddd-eda/tests/E2E/Middleware/MultiClientFixtureSimulationTest.php`, alineado al bounded context **Middleware** y a la capa **Unknown**.
...
## Descripción
Ejecución PHPUnit sobre la clase `MultiClientFixtureSimulationTest`. Las aserciones concretas están en el código fuente del test; esta ficha documenta el propósito y la lectura arquitectónica.
