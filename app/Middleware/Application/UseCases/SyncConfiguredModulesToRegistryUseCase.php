...
/**
 * Upserts registry rows from:
 * 1) config/eventbus.php (producers + subscriptions) — routing del bus;
 * 2) config/modules.php → catalog desde modules_config.json — alineación con el Dashboard declarativo.
 *
 * Misma tabla y merge que el tráfico observado: deduplica (logical_id + rol + event_type) en un solo sync.
 */
